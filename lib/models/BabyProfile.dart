...
class BabyProfile extends Model {
  ...
  factory BabyProfile({String? id, required String name, required TemporalDate birthday, required String country, int? zipcode, required String gender}) {
  ...
  BabyProfile copyWith({String? name, TemporalDate? birthday, String? country, int? zipcode, String? gender}) {
    return BabyProfile._internal(
      id: id,
      name: name ?? this.name,
  ...
  Map<String, Object?> toMap() => {
    'id': id, 'name': _name, 'birthday': _birthday, 'country': _country, 'zipcode': _zipcode, 'gender': _gender, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };

  static final QueryModelIdentifier<BabyProfileModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<BabyProfileModelIdentifier>();
